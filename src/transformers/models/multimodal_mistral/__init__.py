...
try:
    ...
    _import_structure["modeling_multimodal_mistral"] = [
...
if TYPE_CHECKING:
    from .configuration_multimodal_mistral import MULTIMODAL_MISTRAL_PRETRAINED_CONFIG_ARCHIVE_MAP, MultimodalMistralConfig
